part of 'package:icourseapp/widgets/pod_package/src/controllers/pod_getx_video_controller.dart';
...
// Set volume between 0.0 - 1.0,
  ...
  Future<void> enableFullScreen(String tag, {String? tagData}) async {
    ...
    if (!isFullScreen) {
      ...
      _enableFullScreenView(tag, tagData: tagData);
      isFullScreen = true;
  ...
  void _enableFullScreenView(String tag, {String? tagData}) {
    if (!isFullScreen) {
