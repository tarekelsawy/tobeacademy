    ...
    Widget scaffold = Scaffold(
      ...
      body: Container(
        ...
        child: LayoutBuilder(builder: (context, constrains) {
          diff = height - constrains.biggest.height;
          _heightScroller = (constrains.biggest.height) / _alphabet.length;
          _sizeHeightContainer = (constrains.biggest.height);
          return Stack(
            children: <Widget>[
              CustomScrollView(
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        //   child: Text(widget.theme?.searchText ?? 'SEARCH', style: Get.textTheme.headline3?.copyWith(fontFamily: kLatoRegular)),
                        // ),
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(fontFamily: kLight),
                                hintStyle: TextStyle(fontFamily: kLight,color: kGray9D)
                            ),
                        ...
                        Padding(
                          padding: const EdgeInsets.all(15.0),
                          child:
                          Text(widget.theme?.lastPickText ?? 'LAST PICK',style: Get.textTheme.bodyLarge?.copyWith(fontFamily: kLight)),
                        ),
                        Container(
                          color: Colors.white,
                          child: Material(
                            ...
                            child: ListTile(
                              leading: Image.asset(
                                assetsPath+widget.initialSelection.flagUri!,
                                width: 32.0,
                              ),
              ...
              if (isShow == true)
                Align(
                  alignment:(!LocalizationService.isRtl())? Alignment.centerRight:Alignment.centerLeft,
